...
public class ScoresProvider extends ContentProvider
{
    ...
    static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, DatabaseContract.LEAGUE_PATH , MATCHES_WITH_LEAGUE);
        matcher.addURI(authority, DatabaseContract.ID_PATH , MATCHES_WITH_ID);
        matcher.addURI(authority, DatabaseContract.DATE_PATH , MATCHES_WITH_DATE);
        return matcher;
    }
